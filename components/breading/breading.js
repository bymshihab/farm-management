...
animalForm.addEventListener("submit", function (event) {
  ...
  const milkTypeDropdown = document.getElementById(
    "milkTypeDropdown"
  ).value;
  const genderTypeDropdown = document.getElementById("genderTypeDropdown").value;
  const productTypeDropdown = document.getElementById("productTypeDropdown").value;
